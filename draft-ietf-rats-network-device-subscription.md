...
* claims is specialized by "PcrQuotes" as specified in the output of either the tpm12-challenge-response-attestation RPC or the tpm20-challenge-response-attestation RPC as specified in {{!RFC9684}}
* eventLogs represents system-event-logs as specified in the output of the log-retrieval output RPC as defined in {{!RFC9684}}
